...
const CategoryTitle = styled(motion.h1)`
  font-family: 'Josefin Sans', sans-serif;
  /* Ideally this would be a Serif font like Merriweather based on image, 
     but using Josefin Sans as per project constraints */
  font-size: 4rem; 
  font-weight: 700;
  color: #8B2E2E; /* Deep reddish brown from image */
...
const CategoryDescription = styled(motion.p)`
  font-family: 'Space Grotesk', sans-serif; /* Using Space Grotesk for body text */
  font-size: 1.25rem;
